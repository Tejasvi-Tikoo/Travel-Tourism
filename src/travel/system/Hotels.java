...
public class Hotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text=new String[]{"JWMarriot","Raddison Blue","Chilly","Classio","The SeaView"};
    ...
    Hotels(){
        ...
        for(int i=0;i<5;i++){
            im[i]=new ImageIcon(getClass().getResource("/images/hotel"+(i+1)+".jpg"));
