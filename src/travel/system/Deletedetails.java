...
public class Deletedetails extends JFrame implements ActionListener{
    ...
    Deletedetails(String username){
        ...
        delete.setBorder(new LineBorder(new Color(191,148,219)));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            cc.s.executeUpdate("delete from account where username='"+username+"'");
            cc.s.executeUpdate("delete from customer where username='"+username+"'");
            cc.s.executeUpdate("delete from package where username='"+username+"'");
            cc.s.executeUpdate("delete from hotel where username='"+username+"'");
